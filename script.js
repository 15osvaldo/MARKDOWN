...
!function() {
    /*
    configuracion de opcion par 'marked' habilita el modo salto de linea y define una funcion para saltar el codio usando Prism.js
     */
    "use strict";
...
/*
personalñiza la forma en que se representan los enlaces para que se abran en una nueva ventana
 */

    const e = new marked.Renderer;
    e.link = function(e, t, a){
        return `<a target="_blanc"  href="${a}">${e}</a>`
    };

    class t extends React.Component {
        /*
        Inicializacion de el estado de los componentes
        */
        constructor(e){
            super(e), 
            this.state = {
            ...
            // vinculación de metodos de manejo de eventos a la instancia del componente
